    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-6">
        <div class="h-100 p-5 text-bg-dark rounded-3">
          <h2>Diamond Mobile Legends</h2>
          <p>Top up diamond Mobile Legends dengan cepat dan terpercaya</p>
          <button class="btn btn-outline-light" type="button" onclick="location.href='Ml.php'">Top Up</button>
        </div>
      </div>
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
          <h2>UC Pubg Mobile</h2>
          <p>Top up UC Pubg Mobile dengan cepat dan terpercaya</p>
          <button class="btn btn-outline-secondary" type="button" onclick="location.href='pubg.php'">Top Up</button>
        </div>
      </div>
    </div>
